...
int main() {
  ...
  if (a > b){
    cout << "A должно быть меньше B." << endl << "Повторите корректный ввод перезапустив программу." << endl << "Досрочное завершение: Ошибка ввода." << endl;
    exit(1);
  }
  ...
  if (n <= 0) {
    cout << "Количество интервалов должно быть больше 0." << endl << "Повторите корректный ввод перезапустив программу." << endl << "Досрочное завершение: Ошибка ввода." << endl;
    exit(1);
  }
  else {
